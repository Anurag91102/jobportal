            ...
            <div class="col-md-6 offset-md-3" id="form" style="border: transparent 4px solid; box-shadow: 0px 0px 25px rgba(0, 0, 0, 0.5);">
                ...
                <form action="/admin_updateuser" method="POST">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="text" class="form-control text" name="phone" placeholder="Enter Mobile Number"  maxlength="10" value="${user.phone}" required autocomplete="off">
                    </div>
                    <div class="form-group mt-2">
                    ...
                    <div class="form-group offset-md-4 mt-4 mb-0">
                      ...
                      <a  class="btn btn-danger mx-3" href="javascript:history.back()">Back</a>
                    </div>
                </form>
            </div>
        </div>
